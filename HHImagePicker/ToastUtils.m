...
//  vsfa
//
//  Created by Sherlock on 15/7/29.
...
#pragma mark -- PrivacyPrompts
+ (void)alertPhotoPromptWithView:(UIView *)view {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil message:GetLocalLanguageTextValue(HHPhotoBrowserPhotoAccessText) preferredStyle:UIAlertControllerStyleAlert];
    
    UIAlertAction *defaultAction1 = [UIAlertAction actionWithTitle:GetLocalLanguageTextValue(HHPhotoBrowserRefusedText) style: UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
    }];
    
    UIAlertAction *defaultAction2 = [UIAlertAction actionWithTitle:GetLocalLanguageTextValue(HHPhotoBrowserSettingText) style: UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
    ...
    [[self viewControllerWithView:view] presentViewController:alertController animated: YES completion: nil];
